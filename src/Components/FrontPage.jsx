        ...
        <AnimatePresence mode="wait">
          ...
          {view === "JOIN" && (
            <motion.div
              ...
              /* When clicking Connect, the menu will scale down and vanish */
              exit={{
                opacity: 0,
                scale: 0.8,
                filter: "blur(10px)",
          ...
          {view === "MURAL" && (
            <motion.div
              key="mural-canvas"
              /* Starts slightly larger and transparent */
              initial={{ opacity: 0, scale: 1.1 }}
              animate={{ opacity: 1, scale: 1 }}
              transition={{
                duration: 0.8,
                ease: [0.16, 1, 0.3, 1], // Custom "Out-Expo" curve for a smooth stop
              }}
